...
<div class="section-heading"><div><p class="eyebrow">Услуги и цены</p><h2 id="services-title">Чем могу помочь</h2></div><p>Цены с «от» — стартовые. Итоговая стоимость зависит от объёма и состояния помещения или вещи.</p></div>
...
<section class="section container reviews-section" id="reviews" aria-labelledby="reviews-title"><div class="section-heading"><div><p class="eyebrow">Отзывы</p><h2 id="reviews-title">Что говорят клиенты</h2></div><p>Отзывы с присланных скриншотов Авито. На момент снимка в профиле было 5 отзывов, оценка — 4,2 из 5.</p></div><div class="review-grid">${reviews}</div></section>
